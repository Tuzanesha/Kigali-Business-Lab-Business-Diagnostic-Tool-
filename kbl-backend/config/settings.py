...
if DEBUG:
    ...
    # Production email settings - AMAZON SES
    EMAIL_BACKEND = 'django_ses.SESBackend'
    AWS_ACCESS_KEY_ID = os.getenv('AWS_SES_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SES_SECRET_ACCESS_KEY')
    AWS_SES_REGION = os.getenv('AWS_SES_REGION', 'eu-north-1')
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'ishimwebuckle@gmail.com')
    print("\n✅ Production email enabled → Using Amazon SES backend\n")
